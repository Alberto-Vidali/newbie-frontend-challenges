...
<template>
  <section class="text-white px-11 flex flex-col flex-1 items-center justify-center gap-5 text-center">
    <h1 class="font-bold text-2xl">Build The Community Your Fans Will Love</h1>
